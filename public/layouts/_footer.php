<footer>
    ...
    Nos réseaux sociaux</div>
            <p>Rejoignez-nous sur les réseaux sociaux pour rester connecté(e) et découvrir les dernières nouvelles !</p>
            <div class="social">
          ...
          <div class="about">
            <div class="h5">Le Plessis-Robinsson </div>
            <a href="#">Téléphone</a>
            <a href="#">Mail</a>
            <a href="#">Adresse</a>
            <a href="#">Horaires</a>
          ...
          <div class="subjects">
            <div class="h5">La maison des Part'Part’Âges</div>
            <a href="#">Téléphone</a>
            <a href="#">Mail</a>
            <a href="#">Adresse</a>
            <a href="#">Horaires</a>
      ...
      <section class="copyright">
        <p><span>©</span> 2023 All Rights Reserved</p>
        <p>
            <a href="#terms">Conditions générales</a>
            |
            <a href="#security">Mentions légales</a>
        </p>
      </section>
    </footer>